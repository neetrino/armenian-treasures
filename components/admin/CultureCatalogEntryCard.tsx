...
export function CultureCatalogEntryCard({ entry, index, onEdit }: CultureCatalogEntryCardProps) {
  ...
  return (
    <button
      ...
      onClick={onEdit}
      className={cn(
        'group relative flex h-full flex-col overflow-hidden rounded-2xl border border-stone-800/80 bg-[#0f1419] text-left shadow-lg transition duration-300 hover:-translate-y-1 hover:border-bronze-500/50 hover:shadow-xl',

...
export function HeroHome(props: HeroHomeProps) {
  ...
  return (
    <section
      id="page-hero"
      data-site-hero
      className="relative isolate -mt-[var(--site-header-height)] w-full overflow-x-hidden bg-heritage-black pt-[calc(var(--site-header-height)+clamp(4.5rem,9vh,6.5rem)+30px)] text-heritage-champagne min-h-[100svh]"
      aria-labelledby="hero-heading"
    >
      <HeroBackground />

      <div className="relative z-10 mx-auto flex min-h-[calc(100svh-var(--site-header-height)-clamp(4.5rem,9vh,6.5rem)-30px)] w-full min-w-0 max-w-[61.25rem] flex-col items-center justify-center px-6 pb-[42px] text-center">
        <motion.div

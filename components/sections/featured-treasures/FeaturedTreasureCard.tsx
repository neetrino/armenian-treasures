...
export function FeaturedTreasureCard({ treasure }: FeaturedTreasureCardProps) {
  ...
  return (
    <Link
      ...
      className={cn(
        'featured-treasure-card group block outline-none',
        !isTile && 'h-full',
        layout === 'tall' && 'featured-treasure-card--tall',
        isTile && 'featured-treasure-card--tile',
        ...
        <>
          ...
          <div className="featured-treasure-card__content">
            ...
            <div className="featured-treasure-card__meta">
              {description ? (
                <p className="featured-treasure-card__description font-display text-[clamp(0.8125rem,0.9vw,0.9375rem)] leading-[1.5]">
                  {description}
                </p>
              ) : (
                <span />

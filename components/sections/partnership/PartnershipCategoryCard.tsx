...
function PartnershipCategoryContent({ category }: PartnershipCategoryCardProps) {
  return (
    <>
      ...
      <h3 className="mt-5 w-full px-2 text-center font-cinzel text-[11px] font-extrabold uppercase leading-[1.25] tracking-[0.04em] text-heritage-gold transition-colors duration-[240ms] group-hover:text-[var(--accent-hover)] sm:text-[12px]">
        {category.title}
      </h3>
    </>
  );

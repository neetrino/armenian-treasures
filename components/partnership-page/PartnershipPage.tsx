...
export async function PartnershipPage() {
  ...
  return (
    ...
    <HeritageLandingShell>
      ...
      {isSectionEnabled(visibility, 'impact') ? <PartnershipImpact /> : null}

      <LandingSectionStack>

        {isSectionEnabled(visibility, 'values') ? <PartnershipValues /> : null}

        {isSectionEnabled(visibility, 'timeline') ? <PartnershipTimeline /> : null}

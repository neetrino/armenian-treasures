...
export function HeaderBar({
  ...
  return (
    <motion.header
      ...
      className="fixed inset-x-0 top-0 z-50 isolate w-full overflow-hidden border-b text-parchment-50"
      style={{
    ...
    >
      <motion.div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-20 backdrop-blur-sm supports-[backdrop-filter]:bg-[#0c0818]/6"
        animate={{
          opacity: isSolid ? 0 : 1,
      ...
      <motion.div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-20 backdrop-blur-md supports-[backdrop-filter]:bg-parchment/90"
        animate={{
          opacity: isSolid ? 1 : 0,
      ...
      <motion.div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 bottom-0 h-px origin-center bg-gradient-to-r from-transparent via-bronze-500/50 to-transparent"
        animate={{
      ...
      <Container className="relative flex h-[4.5rem] items-center justify-between gap-3 sm:h-[4.75rem] sm:gap-4 lg:h-[5.5rem] lg:gap-6 xl:h-24">
        ...
        <motion.div
          className="relative z-10 hidden min-w-0 flex-1 lg:flex lg:justify-center lg:px-2 xl:px-4"

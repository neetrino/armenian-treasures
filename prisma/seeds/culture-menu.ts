...
const TREE: TopNode[] = [
    ...
    children: [
      {
        slug: 'myths-and-gods',
        title: 'Myths & Gods',
        description: 'Creation epics, pagan deities and cosmological stories.',
        order: 1,
        routeType: 'SUBCATEGORY',
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        slug: 'icons-of-history',
        title: 'Icons of History',
        description: 'Kings, dynasties and statesmen who shaped Armenian statehood.',
        order: 1,
        routeType: 'SUBCATEGORY',
      },
      {
        ...
        description: 'Pioneers of medicine, astronomy, linguistics and invention.',
        order: 2,
        routeType: 'SUBCATEGORY',
      },
      {
        slug: 'famous-armenians',
        title: 'Famous Armenians',
        description: 'Artists, leaders and innovators across the diaspora.',
        order: 3,
        routeType: 'SUBCATEGORY',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        slug: 'capitals',
        title: 'Capitals',
        description: 'Urartian, medieval and modern seats of Armenian power.',
        order: 2,
        routeType: 'SUBCATEGORY',
      },
      {
        slug: 'battles-and-wars',
        title: 'Battles & Wars',
        description: 'Military history and decisive campaigns.',
        order: 3,
        routeType: 'SUBCATEGORY',
      },
      {
        slug: 'christian-heritage',
        title: 'Christian Heritage',
        description: 'Faith, liturgy and the first Christian nation.',
        order: 4,
        routeType: 'SUBCATEGORY',
      },
      {
        slug: 'chronicles-and-manuscripts',
        title: 'Chronicles & Manuscripts',
        description: 'Historiography, printing and manuscript culture.',
        order: 5,
        routeType: 'SUBCATEGORY',
      },
      {
        slug: 'monuments-and-landmarks',
        title: 'Monuments & Landmarks',
        description: 'Sites of memory, archaeology and national landmarks.',
        order: 6,
        routeType: 'SUBCATEGORY',
      },
      {
        slug: 'traditions',
        title: 'Traditions',
        description: 'Living customs, rituals and intangible heritage.',
        order: 7,
        routeType: 'SUBCATEGORY',
      },
    ],
  },
  {
    ...
    children: [
      ...
      { slug: 'sculpting', title: 'Sculptors', order: 7, routeType: 'SUBCATEGORY' },

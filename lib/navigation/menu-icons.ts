...
const SLUG_ICON_MAP: Record<string, CulturalPortalIconKey> = {
  ...
  'legends-and-heroes': 'legends',
  'icons-of-history': 'kings',
  'famous-armenians': 'famousArmenians',
  'historical-events': 'history',
  capitals: 'capitals',
  'battles-and-wars': 'battlesAndWars',
  'christian-heritage': 'christianHeritage',
  'chronicles-and-manuscripts': 'chroniclesAndManuscripts',
  'monuments-and-landmarks': 'monumentsAndLandmarks',
...
const SLUG_LUCIDE_MAP: Record<string, LucideIcon> = {
  ...
  kings: Crown,
  capitals: Scroll,
  battlesAndWars: Swords,
  christianHeritage: Church,
  chroniclesAndManuscripts: Library,
  monumentsAndLandmarks: Building2,

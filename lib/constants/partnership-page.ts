    ...
    partners: [
      {
        ...
        wide: true,
        logo: LOGO('partner-01.png', 'Ministry of Education, Science, Culture and Sports'),
      },
    ],
  },
  {
    ...
    partners: [
      {
        ...
        href: '/culture',
        arrow: 'View Institution →',
        logo: LOGO('partner-03.jpg', 'Erebuni Museum-Reserve', true),
      },
      {
      ...
      },
      {
        ...
        arrow: 'View Institution →',
        logo: LOGO('partner-04.png', 'Aram Khachaturian House-Museum'),
      },
      {
    ...
    partners: [
      {
        ...
        arrow: 'View Institution →',
        wide: true,
        logo: LOGO('partner-06.jpg', 'TUMO Center for Creative Technologies', true),
      },
    ],
  },
  {
    ...
    partners: [
      {
        ...
        href: '/culture',
        arrow: 'View Institution →',
        logo: LOGO('partner-07.jpg', 'Calouste Gulbenkian Foundation'),
      },
      {
        ...
        href: '/culture',
        arrow: 'View Institution →',
        logo: LOGO('partner-08.jpg', 'Tufenkian Foundation'),
      },
      {
        ...
        href: '/culture',
        arrow: 'View Institution →',
        logo: LOGO('partner-09.jpg', 'Armenian General Benevolent Union'),
      },
    ],
  },
  {
